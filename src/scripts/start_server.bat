...
if %errorlevel% equ 0 (
    ...
    if defined PID (
        ...
        if "!choice!"=="1" (
            ...
            java -cp "out\production\stupid_bd;C:\Users\loona\.m2\repository\org\antlr\antlr4-runtime\4.13.1\antlr4-runtime-4.13.1.jar" lib.network.SQLServer 5432
        ) else if "!choice!"=="2" (
            echo.
            echo Iniciando servidor em porta alternativa...
            java -cp "out\production\stupid_bd;C:\Users\loona\.m2\repository\org\antlr\antlr4-runtime\4.13.1\antlr4-runtime-4.13.1.jar" lib.network.SQLServer 5433
        ) else (
            echo.
            echo Cancelado.
            pause
